...
import com.heyan.lancet.internal.entity.InsertInfo;
import com.heyan.lancet.internal.entity.ProxyInfo;
import com.heyan.lancet.internal.entity.ReplaceInfo;
import com.heyan.lancet.internal.entity.ReplaceInvokeInfo;
import com.heyan.lancet.internal.graph.GraphUtil;
import com.heyan.lancet.internal.parser.AopMethodAdjuster;
import com.heyan.lancet.internal.util.AnnotationNodeUtil;
import com.heyan.lancet.internal.util.TypeUtils;
...
public class WeaverMethodParser {
    ...
    public void parse() {
        ...
        if (this.weaverType ==WeaverType.INSERT){
            ...
            Type newExtraType;
            String newExtraClassType = "";
            if (Type.getArgumentTypes(methodNode.desc).length > 2) {
                newExtraType = Type.getArgumentTypes(methodNode.desc)[2];
                newExtraClassType = newExtraType.getClassName().replace('.', '/');
            }
